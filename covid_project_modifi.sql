...
## 2.- showing continents with highest death per population. Ojo usa  unsigned como tipo integer
...
FROM
    coviddeaths
WHERE
    continent IS not NULL and location not in('World','European Union','International','Europe',
    'North America','Asia','South America','Africa','Oceania','High income','Low income') 
GROUP BY  continent
